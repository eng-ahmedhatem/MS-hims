...
import { FiSend, FiArrowRight, FiUser, FiBriefcase, FiPhone, FiAlertCircle, FiFileText, FiChevronDown, FiCheckCircle } from 'react-icons/fi';
  ...
  return (
    <div className="min-h-screen font-cairo relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-indigo-50/30 p-4 md:p-6">
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <button
          onClick={() => navigate(-1)}
          className="inline-flex items-center gap-2 text-gray-600 hover:text-indigo-600 bg-white/70 backdrop-blur-sm rounded-full px-4 py-2 shadow-md border border-white/60 mb-6 transition-colors text-sm"
        >
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 p-6 md:p-8 animate-fadeInUp">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-base mt-2 mr-3">أدخل بياناتك وسيتم معالجة الطلب بأسرع وقت</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="مثال: شئون الموظفين"
                  className="w-full p-3.5 bg-white/60 backdrop-blur-sm border border-white/60 rounded-2xl text-gray-800 placeholder-gray-400 text-base focus:outline-none focus:ring-2 focus:ring-indigo-500 shadow-md transition-all"
                  value={form.office}
