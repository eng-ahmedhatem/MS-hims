...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex font-cairo bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-900 relative overflow-hidden">
      {/* صورة خلفية */}
      ...
      <div className="relative z-10 w-full flex items-center justify-center p-4 sm:p-6">
        <div className="w-full max-w-md">
          ...
          <button
            onClick={() => navigate(-1)}
            className="mb-4 flex items-center gap-2 text-white/80 hover:text-white bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full transition-all duration-200 hover:bg-white/20"
          >
          ...
          {/* البطاقة الزجاجية */}
          <div className="bg-white/10 backdrop-blur-2xl rounded-3xl shadow-2xl ring-1 ring-white/20 overflow-hidden">
            {/* الترويسة مع اللوجو الجديد */}
            <div className="relative h-36 bg-gradient-to-r from-blue-600 to-blue-400 overflow-hidden">
              <div className="relative z-10 flex flex-col items-center justify-center h-full">
                {/* صورة اللوجو */}
                <img
                  src="https://lmsg1.himsb.edu.eg/pluginfile.php/1/theme_academi/logo/1762726301/HIMS.png"
                  alt="شعار النظام"
                  className="w-16 h-16 object-contain mb-1 drop-shadow-lg rounded-full bg-white/10 p-1 ring-2 ring-white/40"
                />
                <h2 className="text-white font-bold text-xl drop-shadow">
                  تسجيل الدخول لنظام الصيانة
                </h2>
              </div>
            </div>
            ...
            <div className="p-8 pt-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-600/30 transition-all duration-200 flex items-center justify-center gap-2 ${
                    loading ? "opacity-80 cursor-wait" : "active:scale-95"
                  }`}
                >
                  {loading ? (
              ...
              <div className="mt-8 pt-4 border-t border-white/20 text-center">
                <p className="text-white/70 text-sm">
                  ...
                  <a
                    href="#"
                    className="text-blue-200 hover:text-white font-bold transition-colors"
                  >
